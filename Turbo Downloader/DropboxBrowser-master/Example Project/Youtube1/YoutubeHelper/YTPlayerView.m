...
{
    ((DBBAppDelegate*)[[UIApplication sharedApplication] delegate]).videoIsInFullscreen = YES;
...
- (void)playerEnded//:(NSNotification*)notification
{
    if(self.forceBackToPortraitMode == YES)
    {
        ...
        ((DBBAppDelegate*)[[UIApplication sharedApplication] delegate]).videoIsInFullscreen = NO;
